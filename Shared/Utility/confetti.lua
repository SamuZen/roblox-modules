...
local types = ReplicatedStorage.Assets:WaitForChild("ConfettiTypes")

local deleteConfettiAfter = 0.7 --Increasing the time will decrease performance
...
function ConfettiCreator.Setup(parent)
	gui = parent
end

--Creates a group of confetti
function ConfettiCreator.CreateConfetti(
	origin: UDim2, 
